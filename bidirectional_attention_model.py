...
# embeddings_index = {}
# with open('/home/ubuntu/.../glove.840B.300d.txt', encoding='utf-8') as f:
#     for line in f:
#         values = line.split(' ')
#         word = values[0]
...
x_train, x_test, y_train, y_test = train_test_split(concat_past_padded_headlines,norm_price,test_size = 0.15,random_state = 2)
...
def build_model():
    ...
    model1.add(Bidirectional(LSTM(rnn_output_size,return_sequences=True,activation=None,kernel_initializer=weights,dropout = dropout)))
    ...
    model2.add(Bidirectional(LSTM(rnn_output_size,return_sequences=True,activation=None,kernel_initializer=weights,dropout = dropout)))
...
model.load_weights('..._deeper=False_wider=False_lr=0.001_dropout=0.5.h5'.format(
                    deeper,wider,learning_rate,dropout))
