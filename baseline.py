...
# This is the baseline model that was already implemented 
def build_model():
    ...
    for wider in [False,True]:
        for learning_rate in [0.001]:
            for dropout in [0.3,0.5]:
                ...
                print()
                save_best_weights = 'baseline_deeper={}_wider={}_lr={}_dropout={}.h5'.format(
                    deeper,wider,learning_rate,dropout)
...
model.load_weights('baseline_deeper={}_wider={}_lr={}_dropout={}.h5'.format(
                    deeper,wider,learning_rate,dropout))
